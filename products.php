        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    ...
                    <p>We have the best product and organic things.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rice.jpg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Rice</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/gas.jpg" alt="gas">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Gas</h3>
                                    <p>Price: Rs. 1910.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/stove.jpg" alt="Stove">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Stove</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/choclate.jpg" alt="choclate">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>choclate</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/coco milk.jpg" alt="coco milk">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>coco milk</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/real.jpg" alt="Real juice">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Real</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wow.jpg" alt="Jack Daniel’s">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Jack Daniel’s</h3>
           ...
           <footer class="footer">
               <div class="container">
               <center>
                   <p>This website is developed  for the purpose of shopping the daily need </p>
               </center
               </div>
           </footer>
        </div>
